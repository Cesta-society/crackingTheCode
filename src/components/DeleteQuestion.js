...
import { fetchQuestions, fetchQuestion, deleteQuestion } from '../actions';
...
export default connect(mapStateToProps, { fetchQuestions,fetchQuestion, deleteQuestion })(DeleteQuestion);